...
def ray_trial(config, label, dispatcher_constructor, project_dir, output_dir, submit_constructor, dispatcher_kwargs=None, submit_kwargs=None, interval=60, data_storage=None, debug_log=None, report=('path', 'config', 'data'),
    ...
    return trial(
        ...
        project_dir=project_dir, output_dir=output_dir, submit_constructor=submit_constructor,
