...
PyrCell['secs']['Adend1']['topol'] = {'parentSec': 'soma', 'parentX': 1.0,
                                      'childX': 0}  # here there is a change: connected to end soma(1) instead of soma(0.5)
...
netParams.synMechParams['NMDA'] = {'mod': 'MyExp2SynNMDABB', 'tau1': 0.05, 'tau2': 5.3, 'tau1NMDA': 15, 'tau2NMDA': 150,
                                   'r': 1, 'e': 0}
...
###############################################################################
# to PYR
netParams.stimSourceParams['NetStim_PYR_SOMA_AMPA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000 * cfg.duration,
                                                       'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_PYR_ADEND3_AMPA'] = {'type': 'NetStim', 'interval': 1,
                                                         'number': 1000 * cfg.duration, 'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_PYR_SOMA_GABA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000 * cfg.duration,
                                                       'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_PYR_ADEND3_GABA'] = {'type': 'NetStim', 'interval': 1,
                                                         'number': 1000 * cfg.duration, 'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_PYR_ADEND3_NMDA'] = {'type': 'NetStim', 'interval': 100,
                                                         'number': int((1000 / 100.0) * cfg.duration), 'start': 0,
                                                         'noise': 1}
...
# to BC
netParams.stimSourceParams['NetStim_BC_SOMA_AMPA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000 * cfg.duration,
                                                      'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_BC_SOMA_GABA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000 * cfg.duration,
                                                      'start': 0, 'noise': 1}
...
# to OLM
netParams.stimSourceParams['NetStim_OLM_SOMA_AMPA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000 * cfg.duration,
                                                       'start': 0, 'noise': 1}
...
netParams.stimSourceParams['NetStim_OLM_SOMA_GABA'] = {'type': 'NetStim', 'interval': 1, 'number': 1000 * cfg.duration,
                                                       'start': 0, 'noise': 1}
...
netParams.stimSourceParams['Septal'] = {'type': 'NetStim', 'interval': 150, 'number': int((1000 / 150) * cfg.duration),
                                        'start': 0, 'noise': 0}
