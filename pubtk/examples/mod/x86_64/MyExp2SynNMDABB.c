...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 MyExp2SynNMDABB /ddn/jchen/dev/optimization/CA3/mod/MyExp2SynNMDABB.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/jchen/dev/optimization/CA3/mod/MyExp2SynNMDABB.mod";
static const char* nmodl_file_text = 
