...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdrcurrent /ddn/jchen/dev/optimization/CA3/mod/CA1ikdr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/jchen/dev/optimization/CA3/mod/CA1ikdr.mod";
static const char* nmodl_file_text = 
