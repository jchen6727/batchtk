...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 nacurrent /ddn/jchen/dev/pubtk/pubtk/examples/mod/CA1ina.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/jchen/dev/pubtk/pubtk/examples/mod/CA1ina.mod";
static const char* nmodl_file_text = 
